...
//@access   Private (only logged in users can see their appt, admin can see all appt)
exports.getAppointments = async (req, res, next) => {
    ...
    //get req.user from auth middleware -> protect func
...
//@access   Private (only logged in users can add appt)
exports.addAppointment = async (req, res, next) => {
    try {
        //only logged in user can add appt -> get req.user from protect middleware
        req.body.user = req.user.id;

        //check for existing appointment -> if the user is not admin, they can only create 3 appointments.
        ...
        req.body.hospital = req.params.hospitalId; //add hospitalId to req.body
...
//@access   Private (only admin can update appt)
...
//@access   Private (only admin can delete appt)
